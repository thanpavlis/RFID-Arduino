...
if (isset($_GET["user_id"])) {
    ...
    $sql = "SELECT uid,name,last FROM xrhstes WHERE uid='" . $_GET["user_id"] . "'";
    ...
    $sql = "SELECT uid,timestamp,eidos FROM kinisi WHERE uid='" . $_GET["user_id"] . "'";
    $result = $conn->query($sql);
    $conn->close();
    ?>
    <html>
                    ...
                    <div class="box">
                        <?php if ($result->num_rows > 0) { ?>
                            <table id="clients" class="table table-hover">
                                ...
                                if (isset($temp)) {
                                    echo "<center><h1>Ο συγκεκριμένος χρήστης δεν υπάρχει !</h1></center>";
                                } else {
                                    echo "<center><h1>Δεν υπάρχει κίνηση για τον συγκεκριμένο χρήστη !</h1></center>";
                                }
                            }
                            ?>
                        </table>
